...
import type { TransactionHistory } from "../hooks/use-inventory-details"
  ...
  "sku-yza2233": [
    {
      ...
      notes: "Standard outbound transaction",
      description: "Outbound transaction for order I-0007263",
      createdBy: "system",
    },
    {
      id: "txn-002",
